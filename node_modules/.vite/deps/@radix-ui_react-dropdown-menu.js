...
import {
  ...
  useLayoutEffect2,
  useSize
} from "./chunk-L4X52KOU.js";
import {
  Primitive,
  dispatchDiscreteCustomEvent
} from "./chunk-7BE3UAEI.js";
import {
  require_react_dom
...
var Menu = (props) => {
  ...
  const isUsingKeyboardRef = React23.useRef(false);
  ...
  return (0, import_jsx_runtime7.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime7.jsx)(
    MenuProvider,
    {
      ...
      children: (0, import_jsx_runtime7.jsx)(
        ...
        {
          scope: __scopeMenu,
          onClose: React23.useCallback(() => handleOpenChange(false), [handleOpenChange]),
          isUsingKeyboardRef,
          dir: direction,
          modal,
          children
...
var MenuAnchor = React23.forwardRef(
  (props, forwardedRef) => {
...
var MenuContent = React23.forwardRef(
  (props, forwardedRef) => {
...
var MenuRootContentModal = React23.forwardRef(
  (props, forwardedRef) => {
    const context = useMenuContext(CONTENT_NAME2, props.__scopeMenu);
...
var MenuRootContentNonModal = React23.forwardRef((props, forwardedRef) => {
  const context = useMenuContext(CONTENT_NAME2, props.__scopeMenu);
  return (0, import_jsx_runtime7.jsx)(
    MenuContentImpl,
    {
...
var MenuContentImpl = React23.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeMenu,
      loop = false,
    ...
    const [currentItemId, setCurrentItemId] = React23.useState(null);
    const contentRef = React23.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef, context.onContentChange);
    const timerRef = React23.useRef(0);
    const searchRef = React23.useRef("");
    const pointerGraceTimerRef = React23.useRef(0);
    const pointerGraceIntentRef = React23.useRef(null);
    const pointerDirRef = React23.useRef("right");
    const lastPointerXRef = React23.useRef(0);
    const ScrollLockWrapper = disableOutsideScroll ? Combination_default : React23.Fragment;
    ...
    useFocusGuards();
    const isPointerMovingToSubmenu = React23.useCallback((event) => {
    ...
    return (0, import_jsx_runtime7.jsx)(
      MenuContentProvider,
      {
        scope: __scopeMenu,
        searchRef,
        onItemEnter: React23.useCallback(
          (event) => {
            if (isPointerMovingToSubmenu(event)) event.preventDefault();
          },
          [isPointerMovingToSubmenu]
        ),
        onItemLeave: React23.useCallback(
          (event) => {
        ...
        onTriggerLeave: React23.useCallback(
          (event) => {
            if (isPointerMovingToSubmenu(event)) event.preventDefault();
          },
          [isPointerMovingToSubmenu]
        ...
        onPointerGraceIntentChange: React23.useCallback((intent) => {
...
var MenuGroup = React23.forwardRef(
  (props, forwardedRef) => {
...
var MenuLabel = React23.forwardRef(
  (props, forwardedRef) => {
...
var MenuItem = React23.forwardRef(
  (props, forwardedRef) => {
...
var MenuItemImpl = React23.forwardRef(
  (props, forwardedRef) => {
    ...
    const [textContent, setTextContent] = React23.useState("");
    React23.useEffect(() => {
      const menuItem = ref.current;
      if (menuItem) {
...
var MenuCheckboxItem = React23.forwardRef(
  (props, forwardedRef) => {
...
var MenuRadioGroup = React23.forwardRef(
  (props, forwardedRef) => {
...
var MenuRadioItem = React23.forwardRef(
  (props, forwardedRef) => {
...
var MenuItemIndicator = React23.forwardRef(
  (props, forwardedRef) => {
...
var MenuSeparator = React23.forwardRef(
  (props, forwardedRef) => {
...
var MenuArrow = React23.forwardRef(
  (props, forwardedRef) => {
...
var MenuSubTrigger = React23.forwardRef(
  (props, forwardedRef) => {
    const context = useMenuContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const rootContext = useMenuRootContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const subContext = useMenuSubContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const contentContext = useMenuContentContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const openTimerRef = React23.useRef(null);
    const { pointerGraceTimerRef, onPointerGraceIntentChange } = contentContext;
    const scope = { __scopeMenu: props.__scopeMenu };
    const clearOpenTimer = React23.useCallback(() => {
      if (openTimerRef.current) window.clearTimeout(openTimerRef.current);
      openTimerRef.current = null;
    }, []);
    React23.useEffect(() => clearOpenTimer, [clearOpenTimer]);
    React23.useEffect(() => {
...
var MenuSubContent = React23.forwardRef(
  (props, forwardedRef) => {
    const portalContext = usePortalContext(CONTENT_NAME2, props.__scopeMenu);
...
var DropdownMenuTrigger = React24.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuContent = React24.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuGroup = React24.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuLabel = React24.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuItem = React24.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuCheckboxItem = React24.forwardRef((props, forwardedRef) => {
...
var DropdownMenuRadioGroup = React24.forwardRef((props, forwardedRef) => {
...
var DropdownMenuRadioItem = React24.forwardRef((props, forwardedRef) => {
...
var DropdownMenuItemIndicator = React24.forwardRef((props, forwardedRef) => {
...
var DropdownMenuSeparator = React24.forwardRef((props, forwardedRef) => {
...
var DropdownMenuArrow = React24.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuSubTrigger = React24.forwardRef((props, forwardedRef) => {
...
var DropdownMenuSubContent = React24.forwardRef((props, forwardedRef) => {
